...
<ul>
    ...
    <li data-id="ini">Ini - <code class=" language-markup">ini</code></li>
...
<ul>
    ...
    <li data-id="solidity">Solidity (Ethereum) - <code class=" language-markup">solidity</code>, <code class=" language-markup">sol</code></li>

...
public partial class App
{
    ...
    private static readonly IHost _host = Host
        ...
        .ConfigureServices((context, services) =>
        {
            ...
            services.AddScoped<EditEntryPage>();
    ...
    private static void InitMessengers()
    {
        ...
        ((IMessengerCompliant)GetService<CreateEntryViewModel>()).RegisterMessages();
        ((IMessengerCompliant)GetService<EditEntryViewModel>()).RegisterMessages();
    }
